...
| `gh-pr-changelog` | Generate functional changelog entries for PRs merged into main by analyzing code changes (default: 10 PRs, supports author filter) | [GitHub CLI](https://cli.github.com/) | |
