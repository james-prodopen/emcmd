...
| `gh-pr-changelog` | Generate functional changelog entries for PRs merged into main by analyzing code changes (default: last 7 days, supports author filter) | [GitHub CLI](https://cli.github.com/) | |
